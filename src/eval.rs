//! Hand evaluation: HCP, shortness, Fifths, BUM-RAP, losing trick count, NLTC,
//! and Zar points.
//!
...
//! individual [`Holding`]s and are bundled into [`SimpleEvaluator`] constants
//! ([`FIFTHS`], [`BUMRAP`], [`BUMRAP_PLUS`], [`NLTC`]) that evaluate a full
//! hand by summing per-suit results.

use crate::{Hand, Holding, Rank, Suit};
use core::cmp::Ord;
use core::iter::Sum;
